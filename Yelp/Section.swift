...
struct Section {
    ...
    var collapsed: Bool
    var minCollapsedItems: Int
    
    init(title: String, items: [[String:Any]] = [], selectionMode: SelectionMode = .multiple, index: Int = 0,
         collapsed: Bool = false, minCollapsedItems: Int = 3) {
        
        self.title = title
        self.items = items
        self.collapsed = collapsed || selectionMode == .single
        self.minCollapsedItems = minCollapsedItems
    ...
    func selectedName() -> String? {
        return items[index]["name"] as? String
    }

    static func dealOptions() -> [[String:String]]{
        return [["name":"Offering a Deal"]]
    }
    
    static func buildDistanceOptions() -> [[String:AnyObject]] {
        return [
    ...
    static func buildSortOptions() -> [[String:AnyObject]] {
        return [
            ["name" : "Best match" as AnyObject, "sort": YelpSortMode.bestMatched as AnyObject],
